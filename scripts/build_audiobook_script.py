...
def preamble() -> str:
    return (
        ...
        "This listening edition focuses on narrative family history, stories, introductions, poems, memories, "
        "and the companion pieces found with the book. Genealogy tables, personal-record forms, source lists, "
        "recipes, and other material best consulted on the page remain in the readable archive, allowing the "
        "spoken edition to move clearly from story to story.\n\n"
